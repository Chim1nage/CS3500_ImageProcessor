...
/**
 * Class GreyScaleLumaCommand represent a command that uses
 * {@link GreyScaleLuma#GreyScaleLuma(ArrayList)}.
 ...
 */
public class GreyScaleLumaCommand extends AbstractCommand {

//  /**
//   * Execution method of GreyScaleLumaCommand.
//   *
...
//    }
//    model.apply(new GreyScaleLuma(old, dest));
//  }
//
//  /**
//   * Execution method of GreyScaleLumaCommand.
...
//    }
//
//    model.apply(new GreyScaleLuma(old, mask, dest));
//  }
  ...
  public void run(IModel model, ArrayList<String> params) throws QuitException{
    model.apply(new GreyScaleLuma(params));
  }
}
