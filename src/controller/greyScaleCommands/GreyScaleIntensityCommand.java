...
/**
 * Class GreyScaleIntensityCommand represent a command that uses
 * {@link GreyScaleIntensity#GreyScaleIntensity(ArrayList)}.
 ...
 */
public class GreyScaleIntensityCommand extends AbstractCommand {

//  /**
//   * Execution method of GreyScaleIntensityCommand.
//   *
...
//    }
//    model.apply(new GreyScaleIntensity(old, dest));
//  }
//
//  /**
//   * Execution method of GreyScaleIntensityCommand.
...
//    }
//
//    model.apply(new GreyScaleIntensity(old, mask, dest));
//  }
  ...
  public void run(IModel model, ArrayList<String> params) throws QuitException{
    model.apply(new GreyScaleIntensity(params));
  }
}
