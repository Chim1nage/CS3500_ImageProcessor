...
/**
 * Class VerticalFlipCommand represent a command that uses
 * {@link VerticalFlip#VerticalFlip(ArrayList)}.
...
//  /**
//   * Execution method of VerticalFlipCommand.
//   *
...
//    }
//    model.apply(new VerticalFlip(old, dest));
//  }
//
//  /**
//   * Execution method of VerticalFlipCommand.
...
//  }
  ...
  public void run(IModel model, ArrayList<String> params) throws QuitException{
    model.apply(new VerticalFlip(params));
  }
}
