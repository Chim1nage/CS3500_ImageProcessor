 ...
 * frequencies after red greyscale.
 */
public class RedHistogram implements IHistogram {
   ...
   */
  public RedHistogram(String name) {
    this.name = name;
  }

  @Override
  public HashMap<Integer, Integer> summary(IModel model) {
    return new CalcHistogram(this.name, "red", model).calc();
  }
}
