 ...
 * frequencies after blue greyscale.
 */
public class BlueHistogram implements IHistogram {
   ...
   */
  public BlueHistogram(String name) {
    this.name = name;
  }

  @Override
  public HashMap<Integer, Integer> summary(IModel model) {
    return new CalcHistogram(this.name, "blue", model).calc();
  }
}
